...
def process_main(mname, out_dir, fmt_str):
    ...
    numTopVars = [1, 2, 3, 4, 5, 7, 10, 15, 20, 25, 35, 50, 65, 75, 85, 100, 125, 150, 175, 200, 250, 350]
    # numTopVars = [1, 2, 3, 4, 5]
    #
    ...
    ps.plot_errors(NAMES, numTopVars, dscore, totalErrs,
                   filename_base, out_dir,compute_results, format_used='pdf', fmt_str=fmt_str)
    #
    logging.shutdown()
...
if __name__ == "__main__":
    ...
    fmt_str = sys.argv[3]
    #
    process_main(mname, out_dir, fmt_str)
